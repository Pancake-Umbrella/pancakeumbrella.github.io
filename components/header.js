    ...
    connectedCallback() {
        this.innerHTML = `
            <header>
                ...
                <aside>
                    <ul class="socials">
                        <li><a title="Itch.io" target="_blank" href="https://pancakeumbrella.itch.io/project-d" style="--highlight: #fa5c5c"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <li><a title="Discord" target="_blank" href="https://discord.com/" style="--highlight: #5865f2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                        ...
                        <li><a title="YouTube" target="_blank" href="https://www.youtube.com/@pancakeumbrella" style="--highlight: #ff0000"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                        ...
                        <li><a title="Twitch" target="_blank" href="https://www.twitch.tv/" style="--highlight: #6441a5"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
